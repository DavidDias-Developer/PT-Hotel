...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        public DAL()
        {
            _SqlConn = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename='C:\\Users\\David\\Desktop\\PT Hotel\\WindowsFormsApplication1\\WindowsFormsApplication1\\bin\\Debug\\Hotel.mdf';Integrated Security=True;Connect Timeout=30");
        }
